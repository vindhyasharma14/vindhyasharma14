...
|:---:|:---:|:---:|:---:|
| Mobile Development | Android + iOS | React Native Expo Bare | Google Play Store |

|  🔒 Security Expert  |  🎬 Media Streaming  |  🏛️ Govt Delivery  |  🏢 Enterprise HRMS  |
|:---:|:---:|:---:|:---:|
| AES-256 + SSL Pinning | ExoPlayer DRM/HLS/DASH | BhooKamp — NCS India | 500+ Employees |
...
| App | Domain | Downloads | Key Contributions |
|-----|---------|-----------|-------------------|
...
| App | Domain | Platform | Tech Highlights |
|-----|---------|----------|-----------------|
| 📚 **KD Live** — iOS | EdTech | App Store | React Native Expo Bare · Video Streaming · Auth Flow |
| 👷 **CILFI HRMS** — iOS | Enterprise | App Store | React Native Expo Bare · GPS · Biometric Integration |
| ⚖️ **App Law** — iOS | Legal / Services | App Store | React Native Expo Bare · Clean UI · API Integration |

</div>

> 💡 All 3 iOS apps built using **React Native Expo Bare Workflow** — delivering true native iOS experiences without a separate Swift/ObjC codebase.
...
[![SmartCalc Card](https://github-readme-stats.vercel.app/api/pin/?username=vindhyasharma14&repo=smartcalc-kotlin&theme=tokyonight&hide_border=true)](https://github.com/vindhyasharma14/smartcalc-kotlin)
...
- ✅ Progressive learning path: beginner → advanced Kotlin concepts
- ✅ Live code execution examples with real-world use cases
- ✅ Clean UI with animated step-by-step walkthroughs
...
```
         Most Android Devs                 Vindhya Sharma
         ─────────────────────────────────────────────────────
         Android only              →    Android + iOS (React Native)
         Basic Retrofit calls      →    ExoPlayer DRM + HLS/DASH streaming
         Basic auth flows          →    AES-256 + SSL Pinning + ProGuard/R8
         Side projects             →    5 Android + 3 iOS apps LIVE in stores
         Single industry           →    Govt (NCS) · Enterprise · EdTech · Startup
         Crash-prone apps          →    99%+ crash-free rate via Crashlytics
         Single platform           →    True cross-platform without compromising native
```
...
|-------|-----------|--------|
| 🎨 **Jetpack Compose** | Building UI components · Migrating XML layouts | 🔄 In Progress |
...
| 💼 Full-Time Roles | 🌐 Freelance | 🤝 Open Source | 📖 Mentoring |
|:---:|:---:|:---:|:---:|
| Android / React Native (Remote preferred) | Android + iOS mobile apps | Android / KMP projects | Junior Android developers |
